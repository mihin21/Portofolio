                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="preview-list">
                        <form action="{{ route('cv_settings.store') }}" method="post" enctype="multipart/form-data">
                          @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                           <a href="{{ route('cv_settings.edit',$cv->id) }}">
                            ...
                            <td>
                                <form action="{{ route('cv_settings.destroy',$cv->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
